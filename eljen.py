...
print ('Do not include fill in depth to water table or ledge')
hwt = int(input("enter HIGHEST (aka worst) SHGWT in area system IN INCHES (eg:  60):  "))
...
elif hwtft <= 4:                      #highest or mean system if water table > 4 ft or < 4 ft
...
ws['U48'] = inv     #INVERT
ws['U49'] = ('Eljen Invert')
ws['U50'] = ('Duplicate - watch manual edits')
...
ws['H15'] = avghigh #PRINTS AVG OR MEAN
...
ws['F18'] = ('Strip Elevation')
ws['H18'] = ('subject to bottom inspection')
ws['I18'] = ('subject to bottom inspection')

ws['G22'] = hwtft    #wt depth
ws['F22'] = 'Seasonal High Water Table Depth'
ws['H22'] = 'FT'
